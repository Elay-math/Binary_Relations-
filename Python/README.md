...
El código crea una matriz de ceros utilizando la librería NumPy y la llena con unos verificando los pares en el conjunto de relaciones:
...
Si extraemos la diagonal de la matriz $M$, obtenemos: Diagonal = $[1, 1, 1, 1]$.
Al contar los unos, el resultado es 4, que coincide con el total de elementos del conjunto. Por lo tanto, el programa concluye correctamente que la relación es **Reflexiva**.
